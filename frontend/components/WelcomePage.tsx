...
export function WelcomePage({ onLoginSuccess }: { onLoginSuccess: () => void }) {
        ...
        {currentStep === 2 && (
          <>
            ...
            <View style={styles.profileImageContainer}>
              <TouchableOpacity style={styles.profileImageButton} onPress={pickImage} disabled={isLoading}>
                {profileImage ? (
                  <Image
